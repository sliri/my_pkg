...
#       
    ...
    def navigate(self): 
     ...
     self.model_state_based_linear_move(10)
#     rospy.sleep(10) 
    ...
    #######################################################################################################################        
        ...
        #try:
         ...
         #http://www.pythonforbeginners.com/dictionary/python-split
          ...
          k=k[0].split('[') 
          k=k[1].split(',')          
          indices = [i for i, s in enumerate(k) if 'jackal::base_link' in s]     #finding the index of the jackal position in the header section
