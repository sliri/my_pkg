...
#       
       ...
       # Set the odom frame
        ...
        self.linear_speed = rospy.get_param("~linear_speed", 1.8) # meters per second 
        ...
        self.orchard_rows =16   #num of rows in the orchard 
    ...
    def navigate(self): 
     ...
     self.model_state_based_linear_move(self.orchard_dx*self.orchard_rows/2-xskew)
   
#     #Go west
     self.model_state_based_rotate_by_angle(-90+angleskew) 
     self.model_state_based_linear_move(self.orchard_dy*self.orchard_columns/2-xskew)
     self.model_state_based_rotate_by_angle(-90+angleskew) 
#     
#     
#     # Cycle through the ochard
    ...
    #Distance In meters
     # Twist is a datatype for velocity
        ...
        move_cmd.linear.x = self.linear_speed if distance > 0 else -self.linear_speed
