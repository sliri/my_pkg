...
cone_radius=0.1
orchard_length=88   #size of the image in inches. The real size is 40 meter=157.48 inch
orchard_width=88    #size of the image in inches. The real size is 36 meter=141.8732 inch 
...
plt.close("all")
fig = plt.figure( dpi=100,figsize=(44,44),frameon=True) #set image size and DPI are optional
