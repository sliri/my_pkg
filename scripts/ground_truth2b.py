...
cone_radius=0.1
orchard_length=112   #size of the image in inches. The real size is 40 meter=157.48 inch
orchard_width=112    #size of the image in inches. The real size is 36 meter=141.8732 inch 
...
plt.close("all")
fig = plt.figure( dpi=100,figsize=(56,56),frameon=True) #set image size and DPI are optional
